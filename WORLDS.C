...
#pragma config(Sensor, in3,    FourBarLin,     sensorLineFollower)
...
#pragma config(Motor,  port1,           DiffL,         tmotorVex393_HBridge, openLoop)
...
#pragma config(Motor,  port10,          DiffR,         tmotorVex393_HBridge, openLoop, reversed)
...
void initializeOpControl(const bool driver) {
	...
	initLiftType(   &mogo,      DIFFERENTIAL, LiftPot,     LiftTop,    LiftBottom,   9000,    -9000          );
	initLiftType(   &FourBar,   BINARY,       FourBarLin,  DiffL,      DiffR,        3800,    2000				   );
