...
void initializeOpControl(const bool driver) {
	...
	initLiftType(	&MogoLift,	DIFFERENTIAL,	LiftPot,		NONE,			LiftTop,	LiftBottom, 2150,	 580	);
	initLiftType(	&FourBar,	NORMAL,	 		FourBarPot,		NONE,			Bar,		NONE,		3900,	 2000,	10);

	//-PID------&reference------sensor------------------thresh----kP-------kI-----kD------reversed----running(opt)
	initPID(	&MogoLift.PID,	MogoLift.sensor[0],	  	30,	    0.45,	0.0,	0.05, 	true, 		true);
